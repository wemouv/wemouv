 ...
 * </p>
 * <p>
 * La classe respecte les contraintes JPA pour les clés composites :
 * <ul>
 * <li>{@code @Embeddable} pour être intégrée dans une entité</li>
 * <li>{@code Serializable} pour la sérialisation réseau/cache</li>
 * <li>Constructeur sans argument</li>
 * <li>Redéfinition stricte de {@code equals()} et {@code hashCode()}</li>
 * </ul>
 * </p>
 */
@Embeddable
public class ParticipationCovoiturageId implements Serializable {
    ...
    /** Identifiant de l'utilisateur (passager) participant au covoiturage. */
    ...
    /**
     * Constructeur pratique pour créer rapidement la clé composite.
     *
     * @param utilisateurId identifiant de l'utilisateur participant
     * @param covoiturageId identifiant du covoiturage cible
     */
